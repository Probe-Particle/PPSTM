...
def test_didv_states_scan_filename_matches_convention(tmp_path: Path, scan_type):
    """Verify PNG filenames for dIdV and states scans follow the required format."""
...
def test_stm_scan_filename_matches_convention(tmp_path: Path, scan_type):
    """Verify PNG filenames for STM scans follow the required format."""
...
def test_voltage_scan_filename_matches_convention(tmp_path: Path, scan_type):
    """Verify PNG filenames for voltage scans follow the required format."""
...
def _plot_png(scan_type: str, save_dir: Path, current: Optional = None, didv: Optional = None):
    visualization.plot_png(_config(scan_type),
                           current = current,
                           didv = didv,
                           voltages=_VOLTAGES,
                           names=_NAMES,
